 ...
 *
 * Позволяет последовательно обходить все элементы составных объектов (или коллекций), не раскрывая их подробностей.
 * Могут быть реализованы разные алгоритмы обхода в разных итераторах.
 */
